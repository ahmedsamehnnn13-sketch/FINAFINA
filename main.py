import random, re, logging, os, asyncio, json
from datetime import datetime, time
from telegram import Update
from telegram.ext import Application, MessageHandler, filters, ContextTypes
from js import Response # مكتبة خاصة ببيئة كلودفلار

# --- الإعدادات ---
TOKEN = "8291199369:AAEb2j0gE0PGR5aGh0R8Rt1h6ezd1mmYUTM"
...
# --- قاعدة بيانات الرد على الاعتراضات ---
OBJECTION_RESPONSES = {
...
# --- الجزء المعدل لـ Cloudflare Workers ---
...
async def on_fetch(request, env):
    ...
    return Response.new("البوت يعمل بنجاح!")
